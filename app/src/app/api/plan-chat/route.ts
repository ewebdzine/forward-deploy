...
- Once the solution firms up, fill the files section: '**Proposed new:**' and '**Proposed edits:**' bullet lists of repo-relative paths with a one-line why each, grounded in your exploration. Append '(verify)' to educated guesses. Keep it current as the plan evolves.
